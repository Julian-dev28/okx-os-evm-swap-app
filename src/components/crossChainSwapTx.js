                ...
                <div className="result-details">
                    ...
                    {quote?.fromToken && (
                        <div className="result-item">
                            ...
                            <span className="result-value">
                                {formatAmount(quote.fromTokenAmount)}{" "}
                    ...
                    {quote?.toToken && (
                        <div className="result-item">
                            ...
                            <span className="result-value">
                                {formatAmount(route.toTokenAmount)}{" "}
                        ...
                        <>
                            ...
                            {route.router.crossChainFee && (
                                <div className="result-item">
                                    ...
                                    <span className="result-value">
                                        {route.router.crossChainFee} USDC
                                    </span>
                                </div>
                            )}
                        </>
                    ...
                    {route?.fromChainNetworkFee && (
                        <div className="result-item">
                            ...
                            <span className="result-value">
                                {formatAmount(route.fromChainNetworkFee)} AVAX
                            </span>
                        </div>
                    )}
                    ...
                    {route?.toChainNetworkFee && (
                        <div className="result-item">
                            ...
                            <span className="result-value">
                                {formatAmount(route.toChainNetworkFee)}
                            </span>
                        </div>
                    )}
                    ...
                    {route?.minimumReceived && (
                        <div className="result-item">
                            ...
                            <span className="result-value">
                                {formatAmount(route.minimumReceived)}
                            </span>
                        </div>
                    )}

                    {/* Route Information */}
                    {route?.fromDexRouterList?.[0]?.subRouterList?.[0]
                        ?.dexProtocol?.[0] && (
                        <div className="result-item">
                    ...
                    {route?.toDexRouterList?.[0]?.subRouterList?.[0]
                        ?.dexProtocol?.[0] && (
                        <div className="result-item">
                            <span className="result-key">
                                Destination Route:
                    ...
                    {route?.estimateGasFee && (
                        <div className="result-item">
                            ...
                            <span className="result-value">
                                {formatAmount(route.estimateGasFee, 8)} AVAX
                            </span>
                        </div>
                    )}
                </div>
